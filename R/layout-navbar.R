#' @title Build navbar layout structure
#' @description Top navbar variant with light theme wrapper
#' @keywords internal
layout_navbar <- function(navbar, sidebar, body, footer, theme = "light", color = NULL, show_theme_button = TRUE) {
  top_nav <- NULL
  ...
  if (!is.null(top_nav) && inherits(top_nav, "tabler.tag") && top_nav$name == "aside") {
    ...
    # Build navbar-light layout header structure with data-bs-theme="light"
