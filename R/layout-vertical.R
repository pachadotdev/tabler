#' @title Build vertical layout structure
#' @description Vertical layout with sidebar on the left
#' @keywords internal
layout_vertical <- function(navbar, sidebar, body, footer, theme = "light", color = NULL, show_theme_button = TRUE) {
  side_nav <- NULL
  ...
  # Ensure sidebar has data-bs-theme="dark" and navbar-expand-lg
