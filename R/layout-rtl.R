#' @title Build rtl layout structure
#' @description Right-to-left layout variant - transforms vertical navbar to horizontal with brand and theme inside ul
#' @keywords internal
layout_rtl <- function(navbar, sidebar, body, footer, theme = "light", color = NULL, show_theme_button = TRUE) {
  top_nav <- NULL
  ...
  # Build RTL header from aside navbar structure
  header_tag <- NULL
  brand_tag <- NULL
