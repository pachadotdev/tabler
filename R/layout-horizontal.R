#' @title Build horizontal layout structure
#' @description Horizontal layout uses a top header/navigation
#' @param navbar Navbar component
#' @param sidebar Not used
#' @param body Body content
#' @param footer Footer
#' @keywords internal
layout_horizontal <- function(navbar, sidebar, body, footer, theme = "light", color = NULL, show_theme_button = TRUE) {
  top_nav <- NULL
