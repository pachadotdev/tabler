...
A modern dashboard framework for R using the beautiful Tabler Bootstrap theme.
...
![layout-geyser](screenshot-fluid-geyser.png "Fluid Layout")
...
![combo](screenshot-combo.png "Combo Layout")
...
![combo-d3po](screenshot-combo-d3po.png "Combo Layout + D3PO")
