        ...
        row(
          col4(
            card(
              ...
              slider_input(bins_input_id, "Number of bins:", min = 1, max = 10, value = 5),
...
# A very simple hardcoded login: user "SpaceMariner", password "IDDQD".
dbWriteTable(con, "passwords", data.frame(user = "SpaceMariner", pass = "IDDQD"))

on.exit(dbDisconnect(con))

# Use queries to compare the information
tabler_app(
  ui,
  server,
